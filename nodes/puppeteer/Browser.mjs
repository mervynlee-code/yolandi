...
export const meta = {
  type: "Puppeteer.Browser", title: "Puppeteer: Browser", category: "Puppeteer", version: 1,
  props: {
    headless: { type: "checkbox", default: true }, engine: { type: "select", default: "chrome", options: ["chrome", "chromium", "firefox"] },
