// =========================
// FILE: admin/activity/puppeteer/index.jsx
// =========================
...
export function create({ manifest, log }){
  const grouped = useMemo(() => {
    ...
    const out = {}; for (const [folder, arr] of Object.entries(g)) { const f = folder.toLowerCase(); if (f.includes("puppeteer")) out[folder] = arr; }
